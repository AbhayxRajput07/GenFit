...
const workoutOptions = [
  { name: 'Running', icon: '≡ƒÅâ' },
  { name: 'Walking', icon: '≡ƒÜ╢' },
  { name: 'Cycling', icon: '≡ƒÜ┤' },
  { name: 'Swimming', icon: '≡ƒÅè' },
  { name: 'Gym Workout', icon: '≡ƒÅï∩╕Å' },
  { name: 'HIIT', icon: '≡ƒöÑ' },
  { name: 'Yoga', icon: '≡ƒºÿ' },
  { name: 'Football', icon: 'ΓÜ╜' },
  { name: 'Cricket', icon: '≡ƒÅÅ' },
  { name: 'Basketball', icon: '≡ƒÅÇ' },
  { name: 'Dance', icon: '≡ƒÆâ' },
  { name: 'Stretching', icon: '≡ƒñ╕' }
];
                ...
                >
                  {grouped[date].map((a: ActivityData) => (
                    <div key={a.id} className="p-4 border-b bg-white">
                      {a.type} ΓÇó {a.durationMinutes}m ΓÇó {a.caloriesBurned} kcal
                    </div>
                  ))}
                </motion.div>
              )}
